    ...
    $.fn.elastic_grid = function(config){
        ...
        for (itemIdx = 0; itemIdx < numOfItems; itemIdx++) {
            if(config.items[itemIdx] != undefined){
                ...
                //initial a object
                aObject = $('<a title="' + item.description +'"></a>');
                aObject.attr('href', item.link);
                ...
                imgObject.attr('title', item.img_title[0] || item.title);
                ...
                figureObject = $('<figure></figure><p class="og-title"></p><a class="see-more" href="' + item.link +'"><i class="fa fa-external-link"> See more</a>');
...
***************************************************************************/
    ...
    if(numOfTag > 1){
        ...
        porfolio_filter.find('a:not(.see-more)').bind('click', function (e) {
    ...
    function createList(text){
        ...
        if(text != ''){
            var li = $('<li data-tooltip="[*]" data-placement="top" >');
            var a = $('<a>',{
                html: text,
                'data-filter': '.'+filter,
                href:'#',
